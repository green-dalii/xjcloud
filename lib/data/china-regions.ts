export const PROVINCE_CITY_DATA: Record<string, string[]> = {
  ...
  '天津市': ['天津市'],
  '重庆市': ['重庆市'],
  '浙江省': ['杭州市', '宁波市', '温州市', '绍兴市', '嘉兴市', '湖州市', '金华市', '衢州市', '舟山市', '台州市', '丽水市'],
  '云南省': ['昆明市', '曲靖市', '玉溪市', '丽江市', '大理州', '西双版纳州', '红河州', '保山市', '普洱市', '临沧市', '德宏州', '怒江州', '迪庆州', '文山州', '楚雄州', '昭通市'],
...
export const PROVINCES = Object.keys(PROVINCE_CITY_DATA)
